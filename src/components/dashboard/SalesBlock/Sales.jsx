      ...
      <BlockContentWrap>
        <div className="cards">
          <div className="card-item card-misty-rose">
            ...
            <div className="card-item-value">₹20,00,000</div>
          ...
          <div className="card-item card-latte">
            ...
            <div className="card-item-value">640</div>
          ...
          <div className="card-item card-nyanza">
            ...
            <div className="card-item-value">456</div>
          ...
          <div className="card-item card-pale-purple">
            ...
            <div className="card-item-value">55</div>
